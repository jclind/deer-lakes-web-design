        ...
        <div className={styles.content}>
          <div className={styles.our_goal}>
            ...
            <p className='section-paragraph text-inverted'>
              ...
              high quality websites have been out of reach for many due to high
              costs and confusing processes. We’re here to change that.
            </p>
          </div>
          <div className={styles.our_values}>
            ...
            <p className='section-paragraph text-inverted'>
              Not only do these values help relationships with our clients, they
              also ensure we create the best website we can for you as well as
